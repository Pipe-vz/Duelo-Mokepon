...
app.use(express.static('public')) //permite en una url servir archivos estaticos para reproducirlos en otros dispositivos del mismo wifi, para entrar a frontend de nuestro servidor en node.js
...
app.post("/mokepon/:jugadorId/ataques", (req, res) => { // coloco una variable en la url que se realiza por medio de ":"
  const jugadorId = req.params.jugadorId || ""
